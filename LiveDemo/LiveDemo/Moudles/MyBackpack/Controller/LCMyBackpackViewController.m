...
@interface LCMyBackpackViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic , weak) LCBaseTableView *mainTableView;
@property (nonatomic , strong) LCMyBackPackViewModel *viewModel;


@end

@implementation LCMyBackpackViewController
...
- (void)lc_addSubviews{
    ...
    [self.navView setCenterLabelText:KLanguage(@"我的背包")];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [tableView fd_heightForCellWithIdentifier:@"LCMybackpackTableViewCell" configuration:^(LCMybackpackTableViewCell * cell) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if(self.viewModel.dataArray.count == 0){
        ...
        cell.titleStr = KLanguage(@"暂无礼物");
        cell.customBgColor = tableView.backgroundColor;
        return cell;
    }
    LCMybackpackTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"LCMybackpackTableViewCell"];
...
#pragma mark---- 懒加载 ----
- (LCMyBackPackViewModel *)viewModel{
    if (_viewModel == nil) {
        _viewModel = [LCMyBackPackViewModel new];
    }
    return _viewModel;
}
...
- (LCBaseTableView *)mainTableView{
    if (_mainTableView == nil){
        ...
        [_mainTableView registerClass:[LCMybackpackTableViewCell class] forCellReuseIdentifier:@"LCMybackpackTableViewCell"];
