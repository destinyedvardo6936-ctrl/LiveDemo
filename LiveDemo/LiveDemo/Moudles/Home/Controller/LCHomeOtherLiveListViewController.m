//
//  LCHomeOtherLiveListViewController.m
//  LiveDemo
//
...
@interface LCHomeOtherLiveListViewController ()< JXPagerViewDelegate, JXCategoryViewDelegate,JXCategoryTitleViewDataSource>
...
@implementation LCHomeOtherLiveListViewController
...
- (id<JXPagerViewListViewDelegate>)pagerView:(JXPagerView *)pagerView initListAtIndex:(NSInteger)index {
    ...
    con.currentFirstChannel = self.currentChannel;
