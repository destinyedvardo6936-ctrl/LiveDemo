...
@interface LCShortVideoListPageViewController ()< JXPagerViewDelegate, JXCategoryViewDelegate,JXCategoryTitleViewDataSource>
...
@implementation LCShortVideoListPageViewController
...
- (void)listScrollViewWillResetContentOffset {
    ...
    for (LCBaseViewController *list in self.pagerView.validListDict.allValues) {
        if ([list isKindOfClass:LCShortVideoListViewController.class]) {
            LCShortVideoListViewController *con = (LCShortVideoListViewController *)list;
...
- (id<JXPagerViewListViewDelegate>)pagerView:(JXPagerView *)pagerView initListAtIndex:(NSInteger)index {
    ...
    LCShortVideoListViewController *con = [[LCShortVideoListViewController alloc] init];
