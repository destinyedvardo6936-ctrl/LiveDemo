...
@interface LCMessageListViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic , weak) LCBaseTableView *mainTableView;
@property (nonatomic , strong) LCMessageListViewModel *viewModel;

@end

@implementation LCMessageListViewController
...
- (void)lc_addSubviews{
    [self.navView setCenterLabelText:KLanguage(@"消息")];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    LCMessageListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"LCMessageListTableViewCell"];
...
- (LCBaseTableView *)mainTableView{
    if (_mainTableView == nil){
        ...
        [_mainTableView registerClass:[LCMessageListTableViewCell class] forCellReuseIdentifier:@"LCMessageListTableViewCell"];
        WS(weakSelf)
