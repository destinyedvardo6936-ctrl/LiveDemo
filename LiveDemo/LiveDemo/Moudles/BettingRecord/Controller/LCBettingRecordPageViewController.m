//
//  LCBettingRecordPageViewController.m
//  LiveDemo
//
...
@interface LCBettingRecordPageViewController ()<JXPagerViewDelegate,JXCategoryViewDelegate,JXCategoryTitleViewDataSource>
...
@implementation LCBettingRecordPageViewController
...
- (void)lc_addSubviews{
    ...
    [self.navView setCenterLabelText:KLanguage(@"投注记录")];
    ...
    self.segmentControl.titles = @[KLanguage(@"彩票"),KLanguage(@"其它")];
...
- (NSUInteger)heightForPinSectionHeaderInPagerView:(JXPagerView *)pagerView{
    return kUI_Width(20)+kUI_Width(4) *2 + kUI_Width(5) + kUI_Width(10);
//    return kUI_Width(22) ;
}
...
- (UIView *)viewForPinSectionHeaderInPagerView:(JXPagerView *)pagerView{
    UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, 0, pagerView.width, kUI_Width(20)+kUI_Width(4) *2 + kUI_Width(5) + kUI_Width(10))];
    view.backgroundColor = Color(@"#FFFFFF");
   
    [view addSubview:self.segmentControl];
//    self.segmentControl.frame = CGRectMake(0, kUI_Width(5), pagerView.width, kUI_Width(20)+kUI_Width(4) *2);
    [self.segmentControl mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(0);
        make.height.equalTo(kUI_Width(20)+kUI_Width(4) *2);
        make.width.equalTo(kUI_Width(46) + kUI_Width(12) + kUI_Width(46));
...
- (id<JXPagerViewListViewDelegate>)pagerView:(JXPagerView *)pagerView initListAtIndex:(NSInteger)index{
    ...
    LCTotalBetingRecordViewController *con = [LCTotalBetingRecordViewController new];
...
- (JXCategoryTitleView *)segmentControl{
    if (_segmentControl == nil) {
        ...
        _segmentControl.contentEdgeInsetLeft = 0;
        _segmentControl.contentEdgeInsetRight = 0;
