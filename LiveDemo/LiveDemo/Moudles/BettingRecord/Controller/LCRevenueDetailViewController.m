//
//  LCRevenueDetailViewController.m
//  LiveDemo
//
...
@interface LCRevenueDetailViewController ()<JXPagerViewDelegate,JXCategoryViewDelegate,JXCategoryTitleViewDataSource>
@property (nonatomic , strong) LCRevenueDetailSegmentViewModel *viewModel;
@property (nonatomic , weak) JXPagerListRefreshView *pagerView;
@property (nonatomic , weak) JXCategoryTitleView *segmentControl;
@end

@implementation LCRevenueDetailViewController
...
- (id<JXPagerViewListViewDelegate>)pagerView:(JXPagerView *)pagerView initListAtIndex:(NSInteger)index{
    ...
    LCRevenueDetailSubViewController *con = [LCRevenueDetailSubViewController new];
...
#pragma mark---- 懒加载 ----
- (LCRevenueDetailSegmentViewModel *)viewModel{
    if (_viewModel == nil) {
        _viewModel = [LCRevenueDetailSegmentViewModel new];
    }
    return _viewModel;
}
