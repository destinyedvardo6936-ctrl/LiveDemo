...
@interface LCMyLeftZSTableViewCell ()
...
@end
@implementation LCMyLeftZSTableViewCell
...
- (UIImageView *)backImgView{
    if(!_backImgView){
        UIImageView *imgView = [[UIImageView alloc]initWithImage:image(@"icon_myWalletLeftZSBg")];
...
- (UIButton *)rechargeBtn{
    if(!_rechargeBtn){
        ...
        [btn setTitle:KLanguage(@"兑换钻石") forState:UIControlStateNormal];
