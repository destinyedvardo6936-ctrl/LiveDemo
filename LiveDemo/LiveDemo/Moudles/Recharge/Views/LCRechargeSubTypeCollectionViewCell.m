//
//  LCRechargeSubTypeCollectionViewCell.m
//  LiveDemo
//
...
@interface LCRechargeSubTypeCollectionViewCell ()
@property (nonatomic , weak) UIImageView *backImgView;

@property (nonatomic , weak) UILabel *mainLabel;
@end
@implementation LCRechargeSubTypeCollectionViewCell
...
- (void)setDataModel:(LCRechargeSubTypeModel *)dataModel{
