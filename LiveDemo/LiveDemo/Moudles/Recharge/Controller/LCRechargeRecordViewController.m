//
//  LCRechargeRecordViewController.m
//  LiveDemo
//
...
@interface LCRechargeRecordViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic , weak) LCBaseTableView *mainTableView;


@property (nonatomic , strong)LCRechargeRecordViewModel *viewModel;

@end

@implementation LCRechargeRecordViewController
...
- (void)lc_addSubviews{
    ...
    [self.navView setCenterLabelText:KLanguage(@"充值记录")];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [tableView fd_heightForCellWithIdentifier:@"LCRechargeRecordTableCell" configuration:^(LCRechargeRecordTableCell * cell) {
...
//    return nil;
    LCRechargeRecordTableCell *cell = [tableView dequeueReusableCellWithIdentifier:@"LCRechargeRecordTableCell"];
    cell.backgroundColor = tableView.backgroundColor;
    cell.contentView.backgroundColor = tableView.backgroundColor;
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
...
- (LCBaseTableView *)mainTableView{
    if (_mainTableView == nil){
        ...
        [_mainTableView registerClass:[LCRechargeRecordTableCell class] forCellReuseIdentifier:@"LCRechargeRecordTableCell"];
...
- (LCRechargeRecordViewModel *)viewModel{
    if(_viewModel == nil){
        _viewModel = [LCRechargeRecordViewModel new];
