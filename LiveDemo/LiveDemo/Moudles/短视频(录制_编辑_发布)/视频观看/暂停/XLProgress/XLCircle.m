...
-(void)buildLayout
{
    ...
    backLayer.strokeColor  = ColorAlpha(@"#f93232", 1).CGColor;
    ...
    [gradientLayer setColors:[NSArray arrayWithObjects:(id)[ColorAlpha(@"#2889f7", 1) CGColor],(id)[ColorAlpha(@"#2889f7", 1) CGColor], nil]];//normalColors
