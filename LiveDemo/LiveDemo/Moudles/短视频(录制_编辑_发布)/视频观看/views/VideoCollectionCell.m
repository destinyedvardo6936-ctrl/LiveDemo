...
- (void)setModel:(NearbyVideoModel *)model{
    ...
    if ([self.isList isEqual:@"1"]) {
        ...
        CGSize size = [str boundingRectWithSize:CGSizeMake(SCREEN_WIDTH*0.65, CGFLOAT_MAX) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:10]} context:nil].size;
