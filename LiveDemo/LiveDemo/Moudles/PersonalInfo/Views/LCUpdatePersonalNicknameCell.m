//
//  LCUpdatePersonalNicknameCell.m
//  LiveDemo
//
...
@interface LCUpdatePersonalNicknameCell ()<UITextFieldDelegate>
@property (nonatomic , weak) UIView *backView;
@property (nonatomic , weak) UILabel *tipLabel;
@property (nonatomic , weak) UITextField *nicknameTextField;
@end
@implementation LCUpdatePersonalNicknameCell
...
- (UITextField *)nicknameTextField{
    if(!_nicknameTextField){
        ...
        textField.attributedPlaceholder = [[NSAttributedString alloc]initWithString:KLanguage(@"请输入昵称") attributes:@{NSFontAttributeName:RegularFont(14),NSForegroundColorAttributeName:Color(@"#999999")}];
