//
//  LCUpdatePersonalProvinceCell.m
//  LiveDemo
//
...
@interface LCUpdatePersonalProvinceCell ()<UITextFieldDelegate>
@property (nonatomic , weak) UIView *backView;
@property (nonatomic , weak) UILabel *tipLabel;
@property (nonatomic , weak) UITextField *nicknameTextField;

@end
@implementation LCUpdatePersonalProvinceCell
...
- (void)setProvince:(NSString *)province{
    ...
    self.nicknameTextField.text = _province;
}
...
- (UITextField *)nicknameTextField{
    if(!_nicknameTextField){
        ...
        textField.attributedPlaceholder = [[NSAttributedString alloc]initWithString:KLanguage(@"请输入省份") attributes:@{NSFontAttributeName:RegularFont(14),NSForegroundColorAttributeName:Color(@"#999999")}];
