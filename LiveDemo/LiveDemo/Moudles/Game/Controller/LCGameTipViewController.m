...
@interface LCGameTipViewController ()<WKNavigationDelegate>
@property (nonatomic , weak) WKWebView *webView;

@end

@implementation LCGameTipViewController
...
- (void)lc_addSubviews{
    ...
    [self.navView setCenterLabelText:KLanguage(@"玩法说明")];
...
//    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:self.contentStr]];
