//
//  LCBettingRecordListViewController.m
//  LiveDemo
//
...
@interface LCBettingRecordListViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic , weak) LCBaseTableView *mainTableView;

@property (nonatomic, copy) void (^scrollBlock)(UIScrollView *scrollView);
@property (nonatomic , strong) LCBettingRecordListViewModel *viewModel;
@end

@implementation LCBettingRecordListViewController
...
- (LCBettingRecordListViewModel *)viewModel{
    if(_viewModel == nil){
        _viewModel = [LCBettingRecordListViewModel new];
