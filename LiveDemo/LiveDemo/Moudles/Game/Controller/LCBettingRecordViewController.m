//
//  LCBettingRecodeViewController.m
//  LiveDemo
//
...
#import "LCBettingRecordListViewController.h"
@interface LCBettingRecordViewController ()<JXPagerViewDelegate,JXCategoryViewDelegate,JXCategoryTitleViewDataSource>
@property (nonatomic , weak) JXPagerListRefreshView *pagerView;
//@property (nonatomic , strong) JXCategoryTitleView *segmentControl;
@end

@implementation LCBettingRecordViewController
...
- (NSUInteger)heightForPinSectionHeaderInPagerView:(JXPagerView *)pagerView{
    return kUI_Width(10);
//    return kUI_Width(14) + kUI_Width(4) + kUI_Width(10) * 2;
//    return kUI_Width(22) ;
}
...
- (UIView *)viewForPinSectionHeaderInPagerView:(JXPagerView *)pagerView{
    UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, 0, pagerView.width, kUI_Width(10))];
    
//
    return  view;
//    UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, 0, pagerView.width, kUI_Width(14) + kUI_Width(4) + kUI_Width(10) * 2)];
...
- (id<JXPagerViewListViewDelegate>)pagerView:(JXPagerView *)pagerView initListAtIndex:(NSInteger)index{
    ...
    LCBettingRecordListViewController *con = [LCBettingRecordListViewController new];
    con.type = index;
    con.biaoshi = self.biaoshi;
...
//
//        _segmentControl.titles = @[KLanguage(@"全部"),KLanguage(@"未开奖"),KLanguage(@"中奖")];
