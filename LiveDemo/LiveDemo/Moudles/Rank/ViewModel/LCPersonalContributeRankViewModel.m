//
//  LCPersonalContributeRankViewModel.m
//  LiveDemo
//
...
@implementation LCPersonalContributeRankViewModel
- (void)lc_initialize{
...
- (LCBaseApi *)getLoadApi{
    ...
    LCPersonalContributeRankListApi *api = [LCPersonalContributeRankListApi new];
