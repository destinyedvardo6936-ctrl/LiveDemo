...
@interface LCFollowListViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic , weak) LCBaseTableView *mainTableView;
@property (nonatomic , strong) LCFollowListViewModel *viewModel;

@end

@implementation LCFollowListViewController
...
- (void)lc_addSubviews{
    ...
    [self.navView setCenterLabelText:KLanguage(@"关注")];
...
//        make.right.mas_equalTo(searchBtn.mas_left);
    ...
    self.emptyDataView.title = KLanguage(@"暂无关注");
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    return [tableView fd_heightForCellWithIdentifier:@"LCFollowListTableViewCell" configuration:^(LCFollowListTableViewCell * cell) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    LCFollowListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"LCFollowListTableViewCell"];
...
#pragma mark---- 懒加载 ----
- (LCFollowListViewModel *)viewModel{
    if (_viewModel == nil) {
        _viewModel = [LCFollowListViewModel new];
...
- (LCBaseTableView *)mainTableView{
    if (_mainTableView == nil){
        ...
        [_mainTableView registerClass:[LCFollowListTableViewCell class] forCellReuseIdentifier:@"LCFollowListTableViewCell"];
        WS(weakSelf)
