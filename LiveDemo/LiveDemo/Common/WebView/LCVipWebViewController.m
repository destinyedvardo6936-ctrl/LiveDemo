...
@interface LCVipWebViewController ()<WKNavigationDelegate>
@property (nonatomic , weak) WKWebView *webView;


@end

@implementation LCVipWebViewController
...
- (void)popBack{
    [[LCNetWorkManager manager]requestApi:[LCUserInfoApi new] success:^(id  _Nullable result) {
