...
NSString *const  shopexplain_url = @"shopexplain_url";
NSString *const  video_watermark = @"video_watermark";
NSString *const  stricker_url = @"stricker_url";
NSString *const  sprout_key_ios = @"sprout_key_ios";
NSString *const  applets_switch = @"applets_switch";
NSString *const  name_score =  @"name_score";
...
+(NSString *)shopexplain_url{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    NSString *getStr = [userDefaults objectForKey:shopexplain_url];
    return getStr;
}
+(NSString *)video_watermark{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    NSString *getStr = [userDefaults objectForKey:video_watermark];
    return getStr;
    
}

+(NSString *)stricker_url{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    NSString *getStr = [userDefaults objectForKey:stricker_url];
    return getStr;
    
}

+(NSString *)sprout_key_ios{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    NSString *getStr = [userDefaults objectForKey:sprout_key_ios];
    return getStr;
...
+(NSString *)name_score {
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    NSString *name = [userDefaults objectForKey:name_score];
    return name;
}
@end
