...
-(void)clickSearchCancle {
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        _topMix.frame = CGRectMake(0, kNavBarHeight, SCREEN_WIDTH, 44+10);
        _searchBar.frame = CGRectMake(12,0, SCREEN_WIDTH-24,40);
        _cancleBtn.frame = CGRectMake(_searchBar.right, _searchBar.top, 80, 40);
        self.mapView.frame = CGRectMake(0,CGRectGetMaxY(_topMix.frame), self.view.bounds.size.width, MapViewH);
        self.tableView.frame = CGRectMake(0, CGRectGetMaxY(self.mapView.frame), self.view.bounds.size.width, self.view.bounds.size.height - MapViewH - kNavBarHeight - 10);
...
-(void)searchBarTextDidBeginEditing:(UISearchBar *)searchBar{
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        _topMix.frame = CGRectMake(0, 0, SCREEN_WIDTH, kNavBarHeight);
        _searchBar.frame = CGRectMake(12,20+statusbarHeight, SCREEN_WIDTH-80-24,40);
        _cancleBtn.frame = CGRectMake(_searchBar.right, _searchBar.top, 80, 40);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.selectedBackgroundView = [[UIImageView alloc]initWithImage:[UIImage imageWithColor:ColorAlpha(@"#f4f5f6", 1) size:CGSizeMake(1.0f,1.0f)]];
    return cell;
}
...
- (void)searchWithSearchOption:(QMSSearchOption *)searchOption didFailWithError:(NSError*)error {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:SearchResultGetPoiSearchResult object:nil userInfo:@{@"data":arr}];
...
-(SearchResultView *)resultView {
    if (!_resultView) {
        ...
        _resultView = [[SearchResultView alloc]initWithFrame:CGRectMake(0,kNavBarHeight, SCREEN_WIDTH, SCREEN_HEIGHT-kNavBarHeight)];
...
-(UIView *)topMix {
    if (!_topMix) {
        _topMix = [[UIView alloc]initWithFrame:CGRectMake(0, kNavBarHeight, SCREEN_WIDTH, 44+10)];
        _topMix.backgroundColor = [UIColor whiteColor];
        
        _searchBar = [[UISearchBar alloc]initWithFrame:CGRectMake(12,2, SCREEN_WIDTH-24,40)];
        _searchBar.backgroundImage = [UIImage imageWithColor:ColorAlpha(@"#f4f5f6", 1) size:CGSizeMake(1.0f,1.0f)];
        _searchBar.placeholder = KLanguage(@"搜索地点");
        _searchBar.delegate = self;
        _searchBar.layer.borderColor = ColorAlpha(@"#969696", 1).CGColor;
...
//        textField.layer.masksToBounds = YES;
        ...
        _cancleBtn.frame = CGRectMake(_searchBar.right, _searchBar.top, 80, 40);
        _cancleBtn.titleLabel.font = RegularFont(15);;
        [_cancleBtn setTitle:KLanguage(@"取消") forState:0];
        [_cancleBtn setTitleColor:[UIColor colorWithRed:255/255.0 green:88/255.0 blue:120/255.0 alpha:1] forState:0];
...
- (void)setMainTableView {
    ...
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.mapView.frame), self.view.bounds.size.width, self.view.bounds.size.height - MapViewH - _topMix.height-kNavBarHeight - KSafeHeight) style:UITableViewStylePlain];
...
-(void)creatNavi {
    ...
    } andRightName:KLanguage(@"发送") andRight:^(id btnBack) {
...
//    [_ybNavi.leftBtn setTitle:KLanguage(@"取消") forState:0];
