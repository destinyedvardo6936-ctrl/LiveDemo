...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        self.backgroundColor = ColorAlpha(@"#f4f5f6", 1);
...
- (void)creatUI{
    ...
    layout.rowCount = 3;
    layout.itemSize = CGSizeMake((SCREEN_WIDTH-20)/7, (SCREEN_WIDTH-20)/7);
    layout.minimumInteritemSpacing = 0;
    layout.minimumLineSpacing = 0;
    layout.scrollDirection = UICollectionViewScrollDirectionHorizontal;
    CGFloat collectinHeight = (SCREEN_WIDTH-20)/7*3;
    collectionView =[[UICollectionView alloc] initWithFrame:CGRectMake(10,10, SCREEN_WIDTH-20,collectinHeight) collectionViewLayout:layout];
    collectionView.backgroundColor = ColorAlpha(@"#f4f5f6", 1);
    ...
    _sendEmojiBtn.frame = CGRectMake(SCREEN_WIDTH-70, collectionView.bottom+sendSpace, 60, 30);
    [_sendEmojiBtn setTitle:KLanguage(@"发送") forState:0];
    [_sendEmojiBtn setTitleColor:[UIColor whiteColor] forState:0];
    _sendEmojiBtn.titleLabel.font = RegularFont(16);
