...
#define kXHVoiceRecordPauseString KLanguage(@"手指上滑，取消发送")
#define kXHVoiceRecordResaueString KLanguage(@"松开手指，取消发送")
...
- (void)pauseRecord {
  ...
  self.backgroundColor = UIColorFromRGBA(0x22202e);//3f80dd
...
- (void)setup {
  self.backgroundColor = UIColorFromRGBA(0x22202e);
