...
- (void)viewDidLoad {
  [super viewDidLoad];
    ...
    self.topToolHeight.constant = kNavBarHeight;
    self.botToolHeight.constant = 45+KSafeHeight;
  [self.navigationController setNavigationBarHidden:YES];
  self.navigationController.navigationBar.translucent = NO;
    topBar.backgroundColor = ColorAlpha(@"#f4f5f6",1);
    bottomBar.backgroundColor = ColorAlpha(@"#f4f5f6",1);
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    UICollectionViewLayoutAttributes *layoutAttributes = [collectionView.collectionViewLayout layoutAttributesForItemAtIndexPath:_currentIndex];
    [collectionView setContentOffset:layoutAttributes.frame.origin animated:YES];
