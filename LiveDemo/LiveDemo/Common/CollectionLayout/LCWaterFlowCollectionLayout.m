...
/** 默认的列数*/
static const NSInteger WSLCefaultColumeCount = 2;
/** 默认的行数*/
static const NSInteger WSLCefaultRowCount = 5;

/** 每一列之间的间距*/
static const NSInteger WSLCefaultColumeMargin = 10;
/** 每一行之间的间距*/
static const CGFloat WSLCefaultRowMargin = 10;
/** 边缘之间的间距*/
static const UIEdgeInsets WSLCefaultEdgeInset = {10, 10, 10, 10};

///** 每一行之间的间距*/
//static const CGSize WSLCefaultHeaderSize = CGSizeMake(0, 66);
///** 每一行之间的间距*/
//static const CGSize WSLCefaultFooterSize = CGSizeMake(0, 66);

@interface LCWaterFlowCollectionLayout ()
/** 存放所有cell的布局属性*/
...
@end
@implementation LCWaterFlowCollectionLayout
...
-(void)prepareLayout {
    ...
    if (self.flowLayoutStyle == LCWaterFlowVerticalEqualWidth) {
    ...
    }else if (self.flowLayoutStyle == LCWaterFlowHorizontalEqualHeight){
    ...
    }else if (self.flowLayoutStyle == LCWaterFlowVerticalEqualHeight || self.flowLayoutStyle == LCLineWaterFlow){
    ...
    }else if(self.flowLayoutStyle == LCWaterFlowHorizontalGrid){
...
-(UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    }else if(self.flowLayoutStyle == LCWaterFlowVerticalEqualHeight){
        
        attrs.frame = [self itemFrameOfVHWaterFlow:indexPath];
        
    }else if(self.flowLayoutStyle == LCLineWaterFlow){
